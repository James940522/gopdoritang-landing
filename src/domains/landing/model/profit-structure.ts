...
export const profitStructureCards: ProfitStructureCard[] = [
  {
    ...
    mobileImage: '/asset/sec-5/fast-cooking-mobile.webp',
  },
  {
    problem: '높은 인건비 = 수익 감소',
    solution: '인건비를 줄이는 운영 시스템',
    caption: '02 / LABOR EFFICIENCY',
    image: '/asset/sec-5/labor-system.webp',
    mobileImage: '/asset/sec-5/labor-system-mobile.webp',
  },
  {
    problem: '복잡한 메뉴 = 운영 스트레스',
    solution: '팔리는 메뉴만 남긴 효율 구조',
    caption: '03 / MENU OPERATION',
    image: '/asset/sec-5/menu-operation.webp',
    mobileImage: '/asset/sec-5/menu-operation-mobile.webp',
  },
];
